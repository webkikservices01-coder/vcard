        ...
        <div className="flex items-center space-x-3">
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-pink-400 focus:border-pink-400 outline-none"
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.08 }} className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <Link to="/dashboard/vcard/profile" className="inline-block mt-4 bg-pink-600 text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-pink-700 transition">
              Create vCard
            </Link>
          </div>
        ) : (
                  ...
                  >
                    ...
                    <td className="px-5 py-4 hidden sm:table-cell">
                      <a
                        ...
                        className="text-xs text-gray-600 hover:text-pink-600 flex items-center space-x-1"
                      >
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center justify-end space-x-1">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="p-2 text-gray-500 hover:text-pink-600 hover:bg-gray-100 rounded-lg transition"
                          title="View"
                        >
